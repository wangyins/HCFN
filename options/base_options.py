...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default='./sample_videos/src/00',
        ...
        parser.add_argument('--bias_input_nc', type=int, default=441, help='# of reference image histogram bins')
        ...
        parser.add_argument('--preprocess', type=str, default='scale_width_and_none', help='scaling and cropping of images at load time [resize_and_crop | crop | scale_width | scale_width_and_crop | none]')
